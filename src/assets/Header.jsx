...
const Header = () => {
  const [cityName, setCityName] = useState(); // State to store the city name input
  ...
  return (
    <div className="container">
      <div className="wrapper">
        <img className="img-1" src="./gb.png" alt="logo" />
        <section>
